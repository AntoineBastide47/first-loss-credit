...
const LABELS = {
  ...
  VaultCreate: "Created a market",
  VaultDelete: "Closed a market",
  LoanBrokerDelete: "Closed a market",
  CredentialDelete: "Revoked access",
  VaultSet: "Changed market settings",
  LoanSet: "Borrowed",
  LoanPay: "Repaid",
  LoanManage: "Managed a loan",
  LoanDelete: "Cleared a finished loan",
  LoanBrokerSet: "Opened a market",
  LoanBrokerCoverDeposit: "Added first-loss cover",
  LoanBrokerCoverWithdraw: "Withdrew first-loss cover",
  MPTokenIssuanceCreate: "Created a token",
  MPTokenAuthorize: "Enabled a token",
  CredentialCreate: "Invited an account",
  CredentialAccept: "Accepted an invitation",
  PermissionedDomainSet: "Set who can deposit",
